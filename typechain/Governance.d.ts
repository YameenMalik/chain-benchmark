...
interface GovernanceInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: "det", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "det", data: BytesLike): Result;
...
export class Governance extends Contract {
  ...
  functions: {
    ...
    det(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    det(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    det(overrides?: CallOverrides): Promise<PopulatedTransaction>;
